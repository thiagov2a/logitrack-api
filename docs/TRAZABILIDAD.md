...
| US-10 | Como Operador, quiero cancelar un envío en estado INICIADO | `test_cancelar_envio_en_estado_iniciado` `test_cancelar_envio_sin_confirmacion_retorna_400` `test_cancelar_envio_fuera_de_estado_iniciado_retorna_400` `test_detalle_operador_en_iniciado_muestra_panel_cancelacion` `test_cancelar_envio_form_operador_en_iniciado_cancela_envio` `test_cancelar_envio_form_sin_confirmacion_muestra_error_y_no_cancela` `test_cancelar_envio_form_fuera_de_iniciado_no_cancela` `test_cancelar_envio_form_con_rol_invalido_no_permite` | `tests/test_envios.py` | PR #15 — `feat/us-10-cancelar-envio-ingresado` |
...
| US-16/18/20 | Cambio de estado individual (Supervisor/Admin) | 5 | ✅ Cubierta |
| US-09 | Editar datos en estado INICIADO | 7 | ✅ Cubierta |
| US-10 | Cancelar envío | 8 | ✅ Cubierta |
